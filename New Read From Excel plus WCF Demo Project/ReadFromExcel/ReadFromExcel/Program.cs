...
namespace ReadFromExcel
{
    ...
    public class myForm : Form
    {
        ...
        private void buildReverseHashTable()
        {
            ...
            //this table will create a reverse hash table for mapping column names to their corresponding field names from the file
            ...
            try
            {
                ...
                //read column names from tables and field names from file from the table core.ivp_securitymaster_attributeFieldMapping
                conn.Open();
