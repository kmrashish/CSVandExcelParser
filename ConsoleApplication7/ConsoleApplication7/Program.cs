...
namespace ConsoleApplication7
{
    class Parser
    {
        static void Main(string[] args)
        {
            ...
            bondHashTable.Add("Asset Type", "has_position");
            bondHashTable.Add("Investment Type", "is_active");
            bondHashTable.Add("Trading Factor", "round_lot_size");
            bondHashTable.Add("Pricing Factor", "bloomberg_unique_name");
            bondHashTable.Add("ISIN", "cusip");
            bondHashTable.Add("BBG Ticker", "isin");
            bondHashTable.Add("BBG Unique ID", "sedol");
            bondHashTable.Add("CUSIP", "bloomberg_ticker");
            bondHashTable.Add("SEDOL", "bloomberg_unique_id");
            ...
            bondHashTable.Add("Risk Currency", "close_price");
